...
function CheckScript(ModuleName, ScriptSRC, FunctionName) {
    ...
    switch (ModuleName.toLowerCase()) {
        ...
        case 'photogallery':
            ...
            ScriptSRC = staticURL + '/cms/Module/PhotoGallery/PhotoGallery.js';
            break;
        case 'comments':
        ...
        case 'moduleview':
            ...
            ScriptSRC = staticURL + '/GlobalAssets/Scripts/min/ModuleViewRenderer_2340.js';
            break;
        ...
        case 'galleria':
            ...
            ScriptSRC = staticURL + '/GlobalAssets/Scripts/ThirdParty/galleria-custom-129/galleria-1.2.9.min.js';
            break;
        case 'fine-uploader':
